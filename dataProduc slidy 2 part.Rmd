<!DOCTYPE html>
  <html>
  <head>
  <title>Analysis of the mtcars dataset</title>
  <meta charset="utf-8">
    <meta name="description" content="Analysis of the mtcars dataset">
      <meta Daniele Franco de Toledo
            ...
            <meta http-equiv="X-UA-Compatible" content="chrome=1">
              <link rel="stylesheet" href="libraries/frameworks/io2012/css/default.css" media="all" >
                ...
                media="only screen and (max-device-width: 480px)" >
                  ...
                  <h1>Analysis of the mtcars dataset</h1>
                  <h2>variables and MPG</h2>
                  <p>Ludovic (A Data Science Student)<br/>Reproducible Pitch Presentation</p>
                  </hgroup>
                  <article></article>  
                  </slide>
                ...
                data-slide=3 title='mtcars dataset - Format'>
                  ...
                  <li>
                  <a href="#" target="_self" rel='tooltip' 
                data-slide=4 title='Analysis - main code'>
                  4
                </a>
                  </li>
                  </ul>
